...
function TaskPopup({ taskPopup, tasks, schedule, getTaskTime, toggleComplete, removeFromDay, assignToDay, togglePin, startEditing, setTaskPopup, getCat, getDurType, getDurationLabel, fmtMins, getDeadlineStatus, saveWeekSchedule, weekOffset, showToast }) {
                            ...
                            <div
                              ...
                              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 4 }}>
                                <div style={{ display: "flex", alignItems: "center", gap: 4, flex: 1, minWidth: 0 }}>
                                  {task.durationType === "ongoing" ? <span style={{ color: cat.color, fontSize: 9 }}>↻</span> : <input type="checkbox" checked={task.completed} onChange={() => toggleComplete(task.id)} style={{ accentColor: cat.color, cursor: "pointer", width: 16, height: 16, flexShrink: 0 }} />}
                                ...
                                {task.durationType !== "ongoing" && (
                                  <button
                                    onClick={(e) => { e.stopPropagation(); removeFromDay(task.id, day); }}
                                    style={{ background: "none", border: "none", color: "#a09890", cursor: "pointer", fontSize: 16, padding: "2px 6px", flexShrink: 0, lineHeight: 1, minWidth: 28, minHeight: 28, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: 4 }}
                                  >×</button>
                                )}
                              </div>
                              {/* Time row */}
