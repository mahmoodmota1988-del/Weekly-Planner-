                  ...
                  {DAYS.map((day, i) => {
                    ...
                    return (
                      <div key={day} onDragOver={(e) => { e.preventDefault(); setDragOver(day); }} onDragLeave={() => setDragOver(null)} onDrop={() => onDrop(day)}
                        style={{ background: isOver ? "#ebe6df" : "#ece7df", border: `1px solid ${isOver ? "#8aa898" : "#d6d0c8"}`, borderRadius: 9, padding: 9, minHeight: 130, transition: "border-color 0.12s, background 0.12s" }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                          <span style={{ fontSize: 10, letterSpacing: "0.12em", color: isOver ? "#a8c4b0" : "#726460" }}>{SHORT_DAYS[i]}</span>
                          {dragTask && !isOver && <span style={{ fontSize: 9, color: "#cec8c0" }}>drop here</span>}
                          {isOver && <span style={{ fontSize: 9, color: "#8aa898" }}>↓ drop</span>}
                        </div>
                        ...
                        {dayTasks.map((task) => {
                          ...
                          return (
                            <div
                              ...
                              style={{ background: isBeingDragged ? "#e4dfda" : "#e9e4db", borderLeft: `2px solid ${task.completed ? "#bcb4aa" : cat.color}`, borderRadius: 3, padding: "4px 6px", marginBottom: 3, cursor: task.durationType !== "ongoing" ? "grab" : "default", opacity: isBeingDragged ? 0.4 : 1, transition: "opacity 0.15s" }}>
                              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 4 }}>
                                <div style={{ display: "flex", alignItems: "center", gap: 4, flex: 1, minWidth: 0 }}>
                                  ...
                                  <span style={{ fontSize: 11, color: task.completed ? "#bcb4aa" : "#847870", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{task.title}</span>
                                </div>
                              ...
                              <div style={{ display: "flex", alignItems: "center", gap: 4, marginTop: 2 }}>
                                ...
                                >
                                  ...
                                  <span style={{ fontSize: 9, color: taskTime ? "#88aa94" : "#cec8c0" }}>
